...
var socketService = /** @class */ (function () {
    ...
    socketService.init = function (HttpServer, namespace, socketConfig, connectionCallback, disconnectCallback) {
        ...
        socketService_1.socketServers.set(namespace, { instance: socketServer, status: core_1.CONNECTION_STATUS.CONNECTED });
        return socketServer;
    };
    socketService.addHandler = function (event, callback, namespace) {
        ...
        if (socketService_1.socketServers.has(namespace)
            && socketService_1.socketServers.get(namespace).status === core_1.CONNECTION_STATUS.CONNECTED) {
